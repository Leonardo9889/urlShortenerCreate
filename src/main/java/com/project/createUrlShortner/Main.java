...
;      } catch (Exception exception){
       ...
       try{
           ...
           System.out.println("Sending object to s3: " + urlDataJson);
           PutObjectRequest request = PutObjectRequest.builder().bucket("bucket-url-shortener-lambda").key(shortUrlCode + ".json").build();
